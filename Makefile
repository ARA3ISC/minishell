...
src/parsing/p_utils7.c src/parsing/p_utils8.c src/parsing/p_utils9.c src/execution/ex_utils1.c src/execution/ex_utils2.c  src/execution/ex_utils3.c 
...
$(NAME): $(OBJ)
	@stty -echoctl
	@make -C costumizing/
	@$(CC) $(CFLAGS) $(OBJ) -o $(NAME)  -lreadline -I ~/Users/eej-jama/goinfre/homebrew/Cellar/readline/8.2.1/include  -L /Users/eej-jama/goinfre/homebrew/Cellar/readline/8.2.1/lib
